        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg font-semibold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-gray-100 dark:to-gray-400 bg-clip-text text-transparent">
                {t('appTitle')}
              </h1>
            </div>
          ...
          <div className="flex items-center gap-2">
            <div className="hidden md:flex items-center gap-1 rounded-lg border border-gray-200 dark:border-gray-800 p-1 bg-gray-50 dark:bg-gray-900">
              {[
            ...
            <div className="flex items-center gap-1 rounded-lg border border-gray-200 dark:border-gray-800 p-1 bg-gray-50 dark:bg-gray-900">
              {[
          ...
          <div className="flex rounded-lg border border-gray-200 dark:border-gray-800 p-1 bg-gray-50 dark:bg-gray-900">
            {[
              ...
              <button
                ...
                onClick={() => onChangeView(key as ViewType)}
                className={cn(
                  'flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium transition-all duration-200',
                  'rounded-md',
                  active === key
                    ? 'bg-white text-gray-900 shadow-sm dark:bg-gray-950 dark:text-white'
                    : 'text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white'
